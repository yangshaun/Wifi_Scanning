...
public class UploadFileToDropbox extends AsyncTask<Void, Void, Boolean> {
	...
	public UploadFileToDropbox(Context context,
			DropboxAPI<AndroidAuthSession> dropbox, String path,
			boolean isloggedin, String id, File tempfile, MainActivity main,
			File oldfile) {
...
//					Log.e("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF", "" +"old   :"+ oldfile.listFiles());
//					return true;
//				}
//			}
			if(tempfile!=null){
				if(tempfile.exists()){//新的檔案存在
					...
					dropbox.putFile(path + id + "_" + new Date() + ".json",
							fileInputStream, tempfile.length(), null, null);
					return true;
				}
			}
